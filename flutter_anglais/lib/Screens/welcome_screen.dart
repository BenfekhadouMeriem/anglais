      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: const LinearGradient(
                  ...
                  colors: [Color(0xFFF47C90), Color(0xFFFC4A5A)],
                ),
              ),
              child: const Center(
                child: Text(
                  'AF', // Remplacez par votre logo ou icône
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 32,
            ...
            // Texte de bienvenue
            Container(
              width: 200, // Ajustez la largeur si nécessaire
            ...
            RoundedButton(
              btnText: 'Login',
              btnColor: Colors.white, // Blanc
              textColor: const Color(0xFFF47C90), // Rose
              onPressed: () {
            ...
            RoundedButton(
              ...
              btnColor: const Color(0xFFF47C90), // Rose
